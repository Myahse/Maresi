...
export function requestStayExtension(id: string, checkOut: string) {
  return api.post<import("@/types").VisitRequest>(`/visit-requests/${id}/extension`, {
    check_out: checkOut,
  });
}
...
export function markStayExtensionPaid(id: string) {
  return api.post<import("@/types").VisitRequest>(`/visit-requests/${id}/extension/paid`, {});
}
